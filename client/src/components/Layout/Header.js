...
const navigation = [
  ...
  { name: 'Projects', href: '#5', current: false },
  { name: 'Education', href: '#2', current: false },
  { name: 'Experience', href: '#3', current: false },
  { name: 'Contact', href: '#6', current: false },
  { name: 'Skills', href: '#4', current: false },
]
...
const Header = () => {
  ...
  return (
    <div>
   <Disclosure as="nav" className="bg-gray-800" style={{width:"100vw"}}>
      {({ open }) => (
        <>
